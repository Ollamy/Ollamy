...
import { IdQuestionModel, QuestionModel } from 'question/question.dto';
...
export class QuestionController {
  ...
  @Post()
  async registerQuestion(@Body() body: QuestionModel, @Headers('Authorization_token') token: string): Promise<string> {
  ...
  @LoggedMiddleware(true)
  @Delete()
  async deleteQuestion(@Body() body: IdQuestionModel, @Headers('Authorization_token') token: string): Promise<string> {
  ...
  @LoggedMiddleware(true)
  @Get('/:id')
  async getQuestion(@Query('id') id: string, @Headers('Authorization_token') token: string): Promise<string> {
  ...
  @LoggedMiddleware(true)
  @Put("/:id")
  async updateQuestion(@Query('id') id: string, @Body() body: QuestionModel): Promise<string> {
