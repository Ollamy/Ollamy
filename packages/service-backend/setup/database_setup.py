...
def test_database_data(cursor: cursor) -> None:
    FAKE_IDS: dict[str, set[str]] = {
        ...
        "UsertoScore": {'2ed5d296-e4bf-4464-a474-a8a33032fd11', '38ff8078-7c0a-46c4-9e2a-d721c5747d36', '890f9e61-eafa-40f0-87da-2534789bee83', 'f23f74bb-ff85-403f-a07b-e4094f9b563d'},
    }
