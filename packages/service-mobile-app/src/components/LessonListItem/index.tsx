import { HStack, Box, VStack, Image, Text, Pressable } from 'native-base';
					...
					<HStack flex="1" alignItems="center" justifyContent="space-between" px={4}>
						<HStack space={4}>
							<Image
								...
								/>
							<VStack space="4px">
								<Text fontSize="sm" fontWeight="normal">{itemName ?? 'Lesson'} {index + 1}</Text>
								<Text fontSize="sm" color="gray.900" fontWeight="bold">{lesson.title}</Text>
							</VStack>
						</HStack>
						<Image
							source={STATUS_TO_ICON[lesson.status]}
							alt="icon"
							size={5}
							resizeMode="contain"
							/>
